...
//vai criar um banco de dados nesse caminho acima

//utilizar o objeto de banco de dados para nossas operações
//metodo serialize roda uma sequencia de codigo
// db.serialize(() =>{
//     //criar uma tabela
//     db.run(`
...
//                 "Colectoria",
//                 "Guilher Gemballa, Jardim America",
//                 "Numero 260",
//                 "Santa Catarina",
//                 "Rio do Sul",
...
//     //consultar os dados da tabels
//             db.all(`SELECT * FROM places`, function(err, rows){ // os asterisco é para mostrar todos os dados, podeira ser apenas name
//                 if(err) {
//                     return console.log(err)
//                 }
